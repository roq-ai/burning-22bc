  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Burning - Your ultimate solution for personal and financial management. Streamline your finances, simplify your life."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Burning - Your ultimate solution for personal and financial management. Streamline your finances, simplify your life.`}
            </Text>
            <Box
